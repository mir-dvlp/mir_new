    ...
    <div className="App">
      <div className='bs-card'>
          ...
          <div className='column'>
            <Card type="item_card hover lg" href="https://langame.ru" src="/ic_langame.svg" name="LANGAME Design"/>
            <Card type="item_card hover msp" href="https://my-study-projects.netlify.app/" src="/ic_code.svg" name="My Study Projects"/>
          </div>
